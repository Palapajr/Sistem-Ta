							...
							<div class="card-box">
								<form role="form" method="post" id="atribut" action="simpan_klasifikasi.php">
									<div class="form-group">
										...
										<input class="form-control" type="text" required="" id="id_pkh" name="id_pkh" placeholder="Contoh : 19xxxxxxxxxxxx">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<input type="radio" name="bumil" id="bumil1" class="bumil" value="1"> Ya
											</span>
											<span class="input-group-addon">
												<input type="radio" name="bumil" id="bumil2" class="bumil" value="0"> Tidak
											</span>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="balita">Tahun</label>
										<!--input type="text" class="form-control" required="" id="tahun" name="tahun" placeholder="Tahun"-->
										<select name="tahun" id="tahun" class="form-control">
											<?php foreach(range(2015, date('Y')) as $th){ ?>
