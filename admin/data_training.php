	...
	<body class="fixed-left">
					...
					<div class="container">
							...
							<div class="col-lg-12">
								<div class="card-box">
									...
									<div class="table-responsive">
											...
											?>
												<tr>													
													...
													<td>
														...
														<a href="proses2.php?ni=<?php echo $row['id_pkh'];?>" class="btn btn-danger" name="delete" onclick="return confirm('Anda Yakin ingin menghapus data <?php echo $row['id_pkh'];?>?');"><i class="fa fa-times m-r-5"></i>Delete</a>
													</td>												
												</tr>	
												<?php  } ?>
												<?php }	?>
										...
										<!--button checkboks -->
										<a href="del_all_training.php" class="btn btn-danger btn-sm waves-effect waves-light m-b-30" onclick="hapus()"><i class="fa fa-times m-r-5"></i>Hapus Semua data</a>
										<!--end -->
									</div>
									<!-- end tabel-->
						...
						<div id="custom-modal" class="modal-demo">
							...
							<div class="custom-modal-text text-left">
								<form role="form" method="post" action="proses2.php">
		...
		$(document).ready(function () {
			$(".editdata").on("click", function(){
				...
				$.post("proses2.php", {read:"", id: id_pkh}, function(res){
